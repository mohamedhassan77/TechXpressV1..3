...
namespace TechXpress.Models
{
    ...
    {
        // For product listings (e.g., featured products)
        ...
        // Category list (for filtering and display)
        ...
        public double AverageRating => Reviews?.Any() == true ? Math.Round(Reviews.Average(r => r.Rating), 1) : 0;
        public int ReviewCount => Reviews?.Count() ?? 0;

        // Additional filtering/search context
